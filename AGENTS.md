...
- Per ogni modello, presentare di norma novelty e limiti in due sottosezioni distinte di quarto livello, intitolate `#### Novelty` e `#### Limiti`, senza accorparle nello stesso paragrafo. Sviluppare `#### Novelty` come una bullet list sintetica, nella quale ogni punto esprima un contributo specifico e riconoscibile del lavoro. Sviluppare `#### Limiti` in uno o più paragrafi autonomi.
